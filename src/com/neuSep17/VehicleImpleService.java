...
public class VehicleImpleService {
    ...
    public ArrayList<Vehicle> searchVechile(String dealerID, HashMap<String, String> searchCretiria) throws NoSuchFieldException{
            ...
            while (sc.hasNext()) {
                ...
                switch (e.getKey().toString()) {
                    ...
                    case "make" :
                        ...
                        break;
                    case "model" :
                        if(v.getModle() == e.getValue()) {
                            results.add(v);
                        }
                        break;
                    case "trim" :
                        if(v.getTrim() == e.getValue()) {
                            results.add(v);
                        }
                        break;
                    case "body type" :
                        if(v.getBodyType() == e.getValue()) {
                            results.add(v);
                        }
                        break;
                    case "price" :
